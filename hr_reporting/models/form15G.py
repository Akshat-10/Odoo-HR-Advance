...
class Form15G(models.Model):
    ...
    def action_generate_excel_report(self):
       ...
       # ===== Common Style =====
        ...
        t1.cell(11,3).text = str(self.estimated_total_income)
        ...
        t1.cell(12,3).text = str(self.other_form15g_details)
        ...
        t1.cell(14,0).text = str(self.other_form15g_count)
        t1.cell(14,2).merge(t1.cell(14,3))
        t1.cell(14,2).text = str(self.other_form15g_amount)
